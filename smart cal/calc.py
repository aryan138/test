    ...
    try:
        ...
        if value == 'C':
            ...
            if eval(ex)>=0:
                ...
                child = Tk()
                child.title('ERROR')
                child.config(bg='dodgerblue3')
                child.geometry('600x240+100+100')
                canvas= Canvas(child,width=1000,height=750,bg="SpringGreen2")
                canvas.create_text(300,50,text="square root of negative is not allowed",fill="black",font=("Helvetica 15 bold"))
                canvas.pack()
                child.mainloop()
            ...
            try:
              answer = eval(ex)**(-1)
                ...
                child.geometry('600x240+100+100')
                canvas= Canvas(child,width=1000,height=750,bg="SpringGreen2")
                canvas.create_text(300,50,text="division by zero = infinite",fill="black",font=("Helvetica 15 bold"))
                canvas.pack()
                child.mainloop()
        elif value == 'x\u00B2':
            answer = eval(ex) ** 2
            ...
            if eval(ex)>0:
                ...
                child.geometry('600x240+100+100')
                canvas= Canvas(child,width=1000,height=750,bg="SpringGreen2")
                canvas.create_text(300,50,text="domain of ln is(0,∞)",fill="black",font=("Helvetica 15 bold"))
                canvas.pack()
                child.mainloop()
            ...
            if eval(ex)>0:
                ...
                child.geometry('600x240+100+100')
                canvas= Canvas(child,width=1000,height=750,bg="SpringGreen2")
                canvas.create_text(300,50,text="domain of log is(0,∞)",fill="black",font=("Helvetica 15 bold"))
                canvas.pack()
                child.mainloop()
            ...
            if eval(ex)>=0:
                ...
                child.geometry('600x240+100+100')
                canvas= Canvas(child,width=1000,height=750,bg="SpringGreen2")
                canvas.create_text(300,50,text="factorial of negative function is out of domain",fill="black",font=("Helvetica 15 bold"))
                canvas.pack()
                child.mainloop()
